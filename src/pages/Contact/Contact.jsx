          ...
          <Row>
            <Col md="12">
              ...
              <p className="body-text mt-1">
                We're excited to hear from you! Whether you have questions, need
                assistance, or just want to share your travel dreams, we're here
                to help. Let's start a conversation and create memorable
              ...
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3 body-text">
                    Need assistance or have questions? Our team is just a call
                    away. Contact us anytime for reliable support and
            ...
            <Col lg="4" md="6" className="mb-4 mb-lg-0">
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3 body-text">
                    Have inquiries or special requests? Drop us an email, and
                    our team will get back to you promptly to assist with all
                    your travel needs.
                  </p>
            ...
            <Col lg="4" md="12" className="mb-4 mb-lg-0">
              <Card className="border-0 shadow rounded-3 mb-4">
                <Card.Body className="text-center">
                  ...
                  <p className="mb-3 body-text">
                    Stay connected and join our travel community! Follow us on
                    our social media platforms for the latest updates, exciting
                    travel tips, and special offers. Let’s connect and share the
                    journey!
                  </p>
